<x-app-layout>
    ...
    <div class="container mx-auto p-4 max-w-md">
        ...
        <form method="POST" action="{{ route('users.store') }}">
            ...
            <label for="password" class="block mt-4 mb-2 font-bold">Contraseña</label>
            ...
            <label for="password_confirmation" class="block mt-4 mb-2 font-bold">Confirmar Contraseña</label>
