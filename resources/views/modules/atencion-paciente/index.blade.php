    ...
    @select-opttion-paciente="pacienteSelect($event.detail)">
        <div x-data="componentPaciente()" @table-reload.window="paginate()" class="bg-white shadow-sm rounded-md">
            ...
            <div class="border">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3">
                    <div class="p-2 col-span-1">
                        <label for="motivoconsulta" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Motivo de consulta</label>
                        <textarea id="motivoconsulta" rows="4" x-model="motivoconsulta" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Motivo de consulta"></textarea>
                    </div>

                    <div class="p-2 col-span-1">
                        <label for="antecedentepersonales" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Antecedentes Personales</label>
                        <textarea id="antecedentepersonales" rows="4" x-model="antecedentepersonales" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Antecedentes Personales"></textarea>
                    </div>

                    <div class="p-2 col-span-1">
                        <label for="antecedentefamiliares" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Antecedentes Familiares</label>
                        <textarea id="antecedentefamiliares" rows="4" x-model="antecedentefamiliares" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Antecedentes Familiares"></textarea>
                    </div>
                </div>
            </div>
            <div class="border">
                ...
                <div class="p-2 w-full">
                    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Análisis
                        Imagen</label>
                </div>
                    ...
                    <div class="p-2 w-1/4">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-file"
                                ...
                                <input id="dropzone-file" type="file" class="hidden" x-model="imagenanalisis"/>
                            </label>
                        </div>
                    </div>

                    <div class="p-2 w-2/4">
                        <pre x-text="JSON.stringify(imagenanalisis)"></pre>
                        <img class="h-auto max-w-lg rounded-lg" src="{{ asset('storage/images/empty-300x240-1.jpg') }}" alt="image description">
            ...
            <div class="border">
                ...
                <div class="p-2 w-full">
                    <label for="message"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Procesamiento</label>
                </div>

                <img src="" width="600" height="600" id="img-result-predictions"
                    alt="Imagen obtenida">


                <div class="p-2 col-span-1">
                    <label for="message"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Resultados</label>
                    <textarea name="procesamiento_resultado" id="procesamiento_resultado" rows="4"
                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Procesamiento de resultados"></textarea>
                </div>

                <div class="p-2 col-span-1">
                    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">% DE
                        AFECTACIÓN</label>
                    <textarea name="procesamiento_afectacion" id="procesamiento_afectacion" rows="4"
                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
